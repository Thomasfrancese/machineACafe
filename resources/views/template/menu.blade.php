<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <!-- Branding image -->
            <img src="../img/logo.png" width="40em" height="50em"/><a class="navbar-brand" href="{{ url('/') }}">La Pause S'Impose</a>
        </div>
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                @if (Illuminate\Support\Facades\Auth::check())
                    ...
                    <li><a href="{{ url('/boisson/listBoisson')}}">Boissons</a></li>
                    <li><a href="{{ url('/ingredients')}}">Ingrédients</a></li>
                    <li><a href="{{ url('/recettes')}}">Recettes</a></li>
